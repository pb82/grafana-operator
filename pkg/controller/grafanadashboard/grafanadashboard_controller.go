...
func (r *ReconcileGrafanaDashboard) matchesSelector(d *integreatlyv1alpha1.GrafanaDashboard, s *v1.LabelSelector) (bool, error) {
...
func (r *ReconcileGrafanaDashboard) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// At this point we have found a dashboard that matches the selector
